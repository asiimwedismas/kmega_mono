...
class ProductUseCasesTest {
    ...
    fun insertProducts() = runBlockingTest {
        ...
        useCases.insertProducts(bread, rockBun)
    ...
    fun ignoreDuplicateInsert() = runBlockingTest {
        ...
        useCases.insertProducts(bread, duplicate)
    ...
    fun updateProducts() = runBlockingTest {
        ...
        useCases.updateProducts(updatedBread)
    ...
    fun deleteProducts() = runBlockingTest {
        ...
        useCases.insertProducts(bread, rockBun, muffin)
        useCases.deleteProducts(bread, muffin)
    ...
    fun getProduct() = runBlockingTest {
        ...
        val allProducts = useCases.getProduct("muffin").getOrAwaitValue()
